    ...
    <div style={{ padding: '16px 16px 0', display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      {stats && (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10 }}>
          ...
          <StatCard label="Best P&L" value={formatINR(stats.bestTradePnl, 0)} trend="positive" />
        </div>
      )}
            ...
            holdings.map((h, i) => (
              ...
              >
                ...
                <div style={{ textAlign: 'right' }}>
                  <p className="mono" style={{ fontSize: 14, fontWeight: 700, color: '#0B0F19', margin: '0 0 2px' }}>{formatINR(h.currentPrice)}</p>
